...
L.round_minplayers = "There is not enough players to start a new round..."
L.round_voting     = "There is a map vote in progress, delaying new round by {num} seconds..."
...
L.win_showreport   = "The round report is being shown for {num} seconds."

L.limit_round      = "The round limit has been reached. {mapname} will load soon."
L.limit_time       = "The time limit has been reached. {mapname} will load soon."
L.limit_left       = "There is {num} round(s) or {time} minutes remaining before the map changes to {mapname}."
...
L.body_burning     = "Oochie-mama! This corpse is on fire!"
...
L.radar_help      = "Scan results show for {num} seconds, after which the Radar will have recharged and can be used again. It will automatically be used after {num} seconds by default, but you can turn that off."
...
L.search_dmg_tele   = "It looks like their DNA was scrambled by tachyon emissions! Whatever that means!"
L.search_dmg_car    = "When this terrorist crossed the road, they were run over by a reckless driver. Don't drink and drive, kids."
L.search_dmg_other  = "You cannot find a specific cause of this terrorist's death. The fate of God? An abusive admin? His soul ragequit?"
...
L.sb_tag_friend = "FRIENDLY"
L.sb_tag_susp   = "NORMAL"
L.sb_tag_avoid  = "SUSPICIOUS"
L.sb_tag_kill   = "DANGEROUS"
...
L.set_fastsw_tip      = "Enable to cycle through weapons without having to click again to equip the weapon. Enable show menu to show the selection menu."
L.set_fastsw_menu     = "Enable menu with fast weapon switch"
L.set_fastswmenu_tip  = "When fast weapons switch is enabled, the weapon selection menu will popup."
L.set_wswitch         = "Disable weapon switch menu auto-closing"
L.set_wswitch_tip     = "By default the weapon selection menu automatically closes a few seconds after you last scroll. Enable this to make it stay up."
...
L.set_specmode_tip  = "Spectate-only mode will prevent you from respawning when a new round starts. Instead, you stay a Spectator. If you're not respawning on round start, check to see if this isn't checked."
...
L.tip8 = "Traitors and Detectives can collect unspent equipment credits from the dead bodies of other Traitors and Detectives by inspecting their body. You can see if a corpse has credits in your crosshair tooltip."
...
L.tip19 = "As Detective, if you have leftover credits you could give a trusted Innocent a Defuser. Then you can spend your time doing the serious investigative work and leave the risky bomb defusal to them. Better them who cuts the wrong wire than you."
...
L.tip32 = "The Crowbar's secondary fire will push other players. It has a slow fire-rate though, so you can't do it too often, you bully!"
...
L.tip35 = "As Traitor, remember you can carry dead bodies with your Magneto-stick and hide them from the prying eyes of the innocent and their Detectives."

L.tip36 = "The tutorial available under {helpkey} contains an overview of the most important keys of the game."

L.tip37 = "On the scoreboard, click the name of a living player and you can select a tag for them such as 'suspicious' or 'friendly'. This tag will show up if you have them under your crosshair."
...
L.tip41 = "If a Detective dies, he drops his DNA scanner as a hula-hoop girl. Pick it up and you can pick up where you left off... or use it to create cover for your rampage."

L.tip42 = "C4 and other explosive weapons do damage to everybody, including you and your T-buddies. Make sure you're out of the blast zone before they go off!"

--I will now put some optional tips for servers that have common custom addons. It's completely optional, since nobody looks at these anyway, but why not?

--L.tip42 = "The Jihad bomb sets off an explosion after a delay, killing you and others around you. However, you make a loud noice and create sparks when you do it, so don't try to make a sneak-attack. Instead, use this in large groups of people to get some extra time and keep things moving."

--L.tip43 = "The silenced AWP allows you to silently snipe opponents. It deals a lot of damage and makes no noise, however it has limited ammo. Make your shots count!"

--L.tip44 = "Earn points through the pointshop by being helpful during rounds or just by playing on the server. You can use it to customize your person, however it may make you more identifiable to enemies."

--L.tip45 = "This server runs a plugin that plays music at the end of every round. If it's bothering you, you can either type 'stopsound' into the console to stop it once it's playing, or press {menukey} and look in the settings tabs to see if you can disable it completely."
...
L.aw_knf2_text  = "was not a Traitor, but still killed someone with a knife. Vendetta?"
...
L.aw_suri2_title = "Balls of Steel"
L.aw_suri2_text = ", after {num} rounds of backstabbing and mass-murder, should probably have recieved some side-effects by now. I'm not seeing any."

L.aw_surt1_title = "Experienced Agent"
L.aw_surt1_text = "has done a few counter-terrorism jobs and knows how to survive {num} rounds without getting his brains blown off."

L.aw_surt1_title = "Cold-blooded Killer"
L.aw_surt1_text = ", with {num} rounds of doing this, you'd think would ponder about if his victims are actual people with wives and children. Doesn't seem like he will any time soon."
